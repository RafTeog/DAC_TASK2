 ...
 * @author viter
 */
@WebServlet(name = "ListarTodosEventosServlet", urlPatterns = {"/ListarTodosEventosServlet"})
public class ListarTodosEventosServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<EventoEntity> eventos = jev.ListarTodosEventos();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Resultado da consulta \"" + "\"</h1>");
            out.println("<p>Foram encontrados "+ k +" evento(s)\""  + "\":<p>");

            Iterator<EventoEntity> eventosAsIterator = eventos.iterator();
            
            while (eventosAsIterator.hasNext()) {
                EventoEntity ent = eventosAsIterator.next();
                ...
                out.println("<p> Area Event:" + ent.getArea_concent_evento()+ "\"</p>");
                

            }
            
            out.println("<p><a href=\"http://localhost:8080/Tarefa2/RetrieveEvent.html\">Nova consulta</a></p>");
            out.println("<p><a href=\"http://localhost:8080/Tarefa2/index.html\">Página Inicial</a></p>");
